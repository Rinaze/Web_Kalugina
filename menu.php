...
class Menu
{
    ...
    private function renderNode(array $node): string
    {
        ...
        if ($hasChildren) {
            ...
            return <<<HTML
                <div class="item item_open" data-parent>
                    <div class="item_inner">
                        <img class="item_arrow" src="img/chevron-down.png" alt="chevron-down" data-open>
                        <img class="item_folder" src="img/folder.png" alt="folder">
                        <span>{$name}</span>
                    </div>
        ...
        return <<<HTML
            <div class="item" data-parent>
                <div class="item_inner">
                    <img class="item_arrow" src="img/chevron-down.png" alt="chevron-down" style="visibility: hidden;">
                    <img class="item_folder" src="img/folder.png" alt="folder">
                    <span>{$name}</span>
                </div>
                <div class="item_items"></div>
            </div>
        HTML;
    }
}